...
server/instance.ts, server/attachments.ts with src/attachments.ts (avatar and file type checks),
src/browser/protocol.ts, dist, website, deploy, and release.env.
